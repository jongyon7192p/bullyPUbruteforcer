/*
This is the original cppwafeltest that dtracers was going to push.
It's here for archiving purposes, and does not work as intended.
*/
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
...
int main(int argc, const char* argv[]) {
  auto game = Game(VERSION_US, argv[1]);
  const auto m64 = load_m64("..\\shared\\1Key_4_21_13_Padded.m64");
